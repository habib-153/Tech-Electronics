      ...
      <div className=" mx-auto min-h-screen ">
        <div className="hero-content mx-auto max-w-xl">
          ...
          >
            ...
            <div className="mt-4">
              <p className="mb-3 font-semibold">Already registered? <Link to='/login' className="text-[#db8710] ">Login</Link></p>
              
              <button className="btn text-white w-full bg-[rgba(6,147,227,1)] hover:bg-[#124796] ">
               Register
              </button>
            </div>
          </form>
